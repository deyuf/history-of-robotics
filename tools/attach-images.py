...
ATTACH = [
    ...
    # ── second-pass additions (humanoid coverage) ───────────────
    ('humanoid', "Honda E0",
        'Honda_P2_front_Honda_Collection_Hall.jpg',
        "Honda's P-series at the Collection Hall — descendants of the secret E-series (CC-BY-SA 3.0)",
        "Honda P-series humanoid"),
    ('humanoid', "Down to 130 kg",
        'Honda_P2_front_Honda_Collection_Hall.jpg',
        "Honda P-series at the Honda Collection Hall (CC-BY-SA 3.0)",
        "Honda P-series humanoid"),
    ('humanoid', "AIST HRP-2",
        'Honda_ASIMO_(ver._2011)_2011_Tokyo_Motor_Show.jpg',
        "Contemporaneous Japanese humanoid — ASIMO at Tokyo Motor Show (CC-BY-SA 3.0)",
        "Japanese humanoid of the early 2000s"),
    ('humanoid', "Schaft and Boston Dynamics",
        'Atlas_frontview_2013.jpg',
        "Boston Dynamics Atlas at the DRC, DARPA (Public domain)",
        "Boston Dynamics Atlas at the DARPA Robotics Challenge"),
    ('humanoid', "Agility Robotics' Digit",
        'Cassie_the_robot_01.jpg',
        "Agility Robotics Cassie — predecessor of Digit (CC-BY-SA 2.0)",
        "Agility Robotics Cassie biped"),
    ('humanoid', "Tesla Bot / Optimus Announced",
        'Optimus_bot_at_Tesla_showroom_-_20251118_-_01.jpg',
        "Tesla Optimus at a Tesla showroom (CC-BY-SA 4.0)",
        "Tesla Optimus humanoid"),
    ('humanoid', "Sanctuary AI Incorporated",
        'Ameca_Generation_1.jpg',
        "Contemporaneous expressive humanoid — Engineered Arts Ameca (CC-BY-SA 4.0)",
        "Contemporary humanoid robot"),
    ('humanoid', "Apptronik's Apollo Concept",
        'Atlas_frontview_2013.jpg',
        "Contemporary US humanoid — Atlas, DARPA (Public domain)",
        "US humanoid robot"),
    ('humanoid', "Figure AI Incorporated",
        'Optimus_bot_at_Tesla_showroom_-_20251118_-_01.jpg',
        "Contemporary general-purpose humanoid — Tesla Optimus (CC-BY-SA 4.0)",
        "General-purpose humanoid"),
    ('humanoid', "1X Closes Series A2",
        'Cassie_the_robot_01.jpg',
        "Contemporary biped — Agility Cassie (CC-BY-SA 2.0)",
        "Biped humanoid"),
    ('humanoid', "Sanctuary Phoenix Gen 6",
        'Ameca_Generation_1.jpg',
        "Contemporary expressive humanoid — Engineered Arts Ameca (CC-BY-SA 4.0)",
        "Expressive humanoid"),
    ('humanoid', "Fourier Intelligence GR-1",
        'Unitree_G1.jpg',
        "Contemporary Chinese humanoid — Unitree G1 (CC0)",
        "Chinese humanoid robot"),
    ('humanoid', "Boston Dynamics Retires Hydraulic",
        'Atlas_climbing_into_a_vehicle.jpg',
        "Boston Dynamics Atlas in action, DARPA (Public domain)",
        "Boston Dynamics Atlas humanoid"),
    ('humanoid', "Figure's $675M",
        'Optimus_bot_at_Tesla_showroom_-_20251118_-_01.jpg',
        "Contemporary general-purpose humanoid (CC-BY-SA 4.0)",
        "General-purpose humanoid"),
    ('humanoid', "NVIDIA's GR00T",
        'Nvidia_logo.svg',
        "NVIDIA logo (Public domain)",
        "NVIDIA"),
    ('humanoid', "Unitree G1",
        'Unitree_G1.jpg',
        "Unitree G1 humanoid (CC0)",
        "Unitree G1 humanoid"),
    ('humanoid', "1X NEO Beta",
        'Cassie_the_robot_01.jpg',
        "Contemporary biped reference — Agility Cassie (CC-BY-SA 2.0)",
        "Biped humanoid"),
    ('humanoid', "Physical Intelligence π0",
        'Atlas_climbing_into_a_vehicle.jpg',
        "Reference humanoid embodiment — Atlas, DARPA (Public domain)",
        "Humanoid robot"),
    ('humanoid', "Six Tigers",
        'Unitree_G1.jpg',
        "Unitree G1 — flagship of China's 'six tigers' (CC0)",
        "Unitree G1 humanoid"),
    ('humanoid', "Apptronik Closes",
        'Atlas_frontview_2013.jpg',
        "Reference US humanoid — Atlas, DARPA (Public domain)",
        "US humanoid robot"),
    ('humanoid', "Figure 02 on the BMW",
        'Optimus_bot_at_Tesla_showroom_-_20251118_-_01.jpg',
        "Reference factory humanoid — Tesla Optimus (CC-BY-SA 4.0)",
        "Factory-deployed humanoid"),
    ('humanoid', "First Commercial Shipments",
        'Unitree_G1.jpg',
        "Unitree G1 — first humanoid at consumer-level pricing (CC0)",
        "Unitree humanoid"),
    ('humanoid', "on the Fremont Floor",
        'Optimus_bot_at_Tesla_showroom_-_20251118_-_01.jpg',
        "Tesla Optimus at a Tesla showroom (CC-BY-SA 4.0)",
        "Tesla Optimus humanoid"),
    ('humanoid', "Vukobratović",
        'Automates-Jaquet-Droz-p1030493.jpg',
        "Historical automata — context for early bipedal theory (CC-BY-SA 2.0)",
        "Historical mechanical automaton"),
    ('humanoid', "WHL-11",
        'TeaAutomatAndMechanism.jpg',
        "Karakuri tea-doll mechanism — Japan's mechanical tradition behind Waseda's walking robots",
        "Karakuri mechanism"),
]
